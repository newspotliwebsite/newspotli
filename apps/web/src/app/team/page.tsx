  ...
  return (
    ...
    >
      ...
      <div className="w-10 h-10 rounded-full bg-gradient-to-br from-green to-green-mid flex items-center justify-center flex-shrink-0">
        <span className="font-noto font-black text-white text-sm leading-none">
      ...
      <main className="bg-cream">
        ...
        <section className="bg-white border-b border-charcoal/8 py-16 md:py-20 px-4 md:px-12 lg:px-24">
          <div className="max-w-5xl mx-auto">
            ...
            >
              <h1 className="font-noto text-5xl md:text-6xl font-black text-charcoal leading-tight">
        ...
        <section className="bg-maroon py-16 md:py-20 px-4 md:px-12 lg:px-24 relative overflow-hidden">
          {/* Watermark */}
          <span className="absolute right-0 top-1/2 -translate-y-1/2 font-noto text-[200px] text-white/[0.03] font-black select-none pointer-events-none hidden lg:block leading-none">
            Join
          </span>
          ...
          <div className="max-w-3xl mx-auto text-center relative">
            ...
            <motion.h2
              ...
              whileInView="visible"
              viewport={VIEWPORT_ONCE}
              className="font-noto text-3xl md:text-4xl font-black text-white mb-4"
            >
