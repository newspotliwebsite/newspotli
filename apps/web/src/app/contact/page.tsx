...
const SOCIALS = [
  { name: 'YouTube', icon: <YouTubeIcon />, href: 'https://youtube.com/@newspotli', color: 'hover:bg-red-600' },
  { name: 'Instagram', icon: <InstagramIcon />, href: 'https://instagram.com/newspotli', color: 'hover:bg-pink-600' },
  { name: 'Facebook', icon: <FacebookIcon />, href: 'https://facebook.com/newspotli', color: 'hover:bg-blue-600' },
  { name: 'X / Twitter', icon: <TwitterIcon />, href: 'https://twitter.com/newspotli', color: 'hover:bg-charcoal' },
  { name: 'LinkedIn', icon: <LinkedInIcon />, href: 'https://linkedin.com/company/newspotli', color: 'hover:bg-[#0077b5]' },
