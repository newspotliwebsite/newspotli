...
export default function AboutCTA() {
  return (
    <section className="bg-maroon py-16 md:py-24 px-4 md:px-12 lg:px-24 relative overflow-hidden">
      ...
      <span className="absolute right-8 top-1/2 -translate-y-1/2 font-playfair text-[180px] font-black italic text-white/[0.03] select-none pointer-events-none leading-none hidden lg:block">
        Mission
      </span>
      ...
      <div className="max-w-3xl mx-auto text-center relative">
        ...
        <h2 className="font-playfair text-3xl md:text-5xl font-black italic text-white leading-tight mb-4">
