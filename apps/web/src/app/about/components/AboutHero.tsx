  ...
  return (
    <section className="bg-cream py-20 md:py-28 px-4 md:px-12 lg:px-24 overflow-hidden">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Main headline */}
        <h1 className="font-playfair text-5xl sm:text-6xl md:text-7xl font-black italic text-charcoal leading-[1.05] mb-6 text-balance">
          भारत के गाँवों की{' '}
        ...
        <div className="mt-12 flex gap-4 items-start max-w-2xl">
          ...
          <p className="font-playfair text-xl md:text-2xl italic text-charcoal/70 leading-relaxed">
