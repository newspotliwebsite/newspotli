      ...
      <main className="bg-cream">
        ...
        <section className="relative bg-gradient-to-br from-maroon-dark via-maroon to-green-dark overflow-hidden py-20 md:py-28 px-4 md:px-12 lg:px-24">
          ...
          <div className="max-w-3xl mx-auto text-center relative">
            ...
            <h1 className="font-noto text-4xl sm:text-5xl md:text-6xl font-black text-white leading-[1.05] mb-2">
            ...
            <div className="flex items-center justify-center gap-2 mb-8">
              ...
              <div className="flex -space-x-2">
                {['#8B1A1A', '#2D5016', '#C8860A', '#1a3a6a'].map((c, i) => (
                  <div key={i} className="w-7 h-7 rounded-full border-2 border-maroon-dark flex items-center justify-center text-white font-noto font-black text-xs" style={{ backgroundColor: c }}>
                    {['क', 'रा', 'स', 'प'][i]}
                  </div>
                ))}
              </div>
        ...
        <section className="py-14 md:py-16 px-4 md:px-12 lg:px-24">
          <div className="max-w-xl mx-auto text-center">
            <h2 className="font-noto text-2xl md:text-3xl font-black text-charcoal mb-2">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="relative bg-[#075E54] rounded-sm overflow-hidden px-6 md:px-10 py-8 flex flex-col sm:flex-row items-center gap-6 sm:gap-8">
              ...
              <div className="flex-1 text-center sm:text-left relative">
                <h3 className="font-noto text-xl md:text-2xl font-black text-white mb-1">
