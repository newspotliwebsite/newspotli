    ...
    <>
      ...
      <main className="bg-cream min-h-screen">
        <div className="max-w-3xl mx-auto px-4 md:px-6 py-12 md:py-20">
          ...
          <h1 className="font-playfair text-4xl md:text-5xl font-black italic text-charcoal mb-8">
          ...
          <div className="prose prose-lg font-noto text-charcoal/80 space-y-6">
            ...
            <h2 className="font-playfair text-2xl font-black italic text-charcoal mt-10 border-l-4 border-gold pl-5">
