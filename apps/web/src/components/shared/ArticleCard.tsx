    ...
    return (
      <Link href={`/article/${article.slug?.current || ''}`} className="group relative block col-span-2 rounded-sm overflow-hidden bg-charcoal min-h-[400px] shadow-xl">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-7">
          ...
          <h3 className="font-playfair font-black italic text-white text-2xl md:text-3xl leading-snug line-clamp-3 group-hover:text-gold transition-colors duration-300 text-balance">
            {article.title}
          </h3>
